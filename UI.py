...
buttonPlusP.pack(side=LEFT, fill=BOTH, expand=YES)  # .grid(column=0,row=13,  sticky=(W,S))
buttonMinusP.pack(side=LEFT, fill=BOTH, expand=YES)  # .grid(column=1,row=13, sticky=(E,S))
